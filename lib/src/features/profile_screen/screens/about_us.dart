                      ...
                      children: [
                        ...
                        Card(
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                const Text("C L I C K B O A R D"),
                                const SizedBox(height: 20,),
                                const Divider(),
                                const SizedBox(height: 20,),
                                const Text(
                                    "Clickboard: Redefining Academia Through Innovation\n\n"
                                    "Welcome to Clickboard, where education meets innovation to redefine your academic experience. "
                               ...
                               const Text("W H Y  C L I C K B O A R D?"),
                                const SizedBox(
                                  height: 20,
                                ),
                               //conversations
                               const Column(mainAxisAlignment: MainAxisAlignment.start,
                                 children: [
                                   //user
                                   UserText(text: "Hello, I need a app that keeps\nme updated about my college",),
                                   //assistant
                                   AssistantText(text: "Absolutely! Have you considered Clickboard? It's amazing!!!",),
                                   //assistant
                                   AssistantText(height:160,width: 300,text: "It's a powerful app for academic updates. Features secure authentication, intuitive navigation, notices, and quick result access."),
                                   //user
                                   UserText(text: "Sounds good. How does it simplify things?"),
                                   //assistant
                                   AssistantText(height:160,text: "Centralizes info—academic results, engaging animations, and easy account management. Your academic journey, simplified."),
                                   //user
                                      ...
                                      children: [
                                        ...
                                        Row(mainAxisAlignment: MainAxisAlignment.center,
                                          ...
                                          IconButton(onPressed: (){
                                            _launchAsInAppWebViewWithCustomHeaders(Uri.parse('https://www.linkedin.com/in/abhigyan103/'));
                                          }, icon: const Icon(FontAwesomeIcons.linkedin,color: AppColors.highlightColDdark,)),
                                          IconButton(onPressed: (){
                                            _launchAsInAppWebViewWithCustomHeaders(Uri.parse('https://www.instagram.com/not.gyaanii/'));
                                          }, icon: const Icon(FontAwesomeIcons.instagram,color: AppColors.highlightColDdark,)),
                                          IconButton(onPressed: (){
                                            _launchAsInAppWebViewWithCustomHeaders(Uri.parse('https://www.facebook.com/abhigyan103'));
                                          }, icon: const Icon(FontAwesomeIcons.facebook,color: AppColors.highlightColDdark,)),
                                        ],)
                                      ],
                                    ),
                                  ),
